...
export interface ProfileAnalysis {
  ...
  imports: Array<{
    ...
    resolvedDatasetTitle: string | null;
  }>;
  setParameters: Array<{
    paramId: string | null;
    label: string | null;
  ...
  relationAudit: {
    kernelControlCount: number;
    methodikControlCount: number;
    sourceUnionControlCount: number;
    anwenderControlCount: number;
    unionMissingInAnwender: number;
    anwenderMissingInUnion: number;
    exactUnionMatch: boolean;
  };
}
